      ...
      <div className="shell about__grid">
        ...
        <div className="about__body">
          <p className="about__p">
            I&apos;m <strong>effect</strong> — a frontend developer working solo. I care
            about the half-second nobody notices: the way a title settles, the
            weight of a scroll, the moment a thing catches and glows.
          </p>
          <p className="about__p">
